...
#define MEASUREMENT_ADC_CHG_PIN         GPIO_PIN0
#define MEASUREMENT_ADC_DSG_PIN         GPIO_PIN1
#define MEASUREMENT_ADC_PACK_D_PIN      GPIO_PIN2
#define MEASUREMENT_ADC_PACK_C_PIN      GPIO_PIN3
#define MEASUREMENT_ADC_Charger_PIN     GPIO_PIN4

#define MEASUREMENT_ADC_NoUsed0_PIN      GPIO_PIN5
#define MEASUREMENT_ADC_NoUsed1_PIN      GPIO_PIN6
#define MEASUREMENT_ADC_NoUsed2_PIN      GPIO_PIN7
